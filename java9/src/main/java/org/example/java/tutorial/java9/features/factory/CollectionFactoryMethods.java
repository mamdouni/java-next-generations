package org.example.java.tutorial.java9.features.factory;
...
public class CollectionFactoryMethods {
	...
	public static void main(String[] args) {
		...
		log.info("{}",ints.getClass());	// ImmutableCollections$ListN
		log.info("{}",List.of(1).getClass());	// ImmutableCollections$List12
